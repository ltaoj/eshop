...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers("/catelogMg").access("hasRole('ADMIN')")
                .antMatchers("/itemMg").access("hasRole('ADMIN')")
                .antMatchers("/orderMg").access("hasRole('ADMIN')")
                .antMatchers("/spplierMg").access("hasRole('ADMIN')")
                .antMatchers("/registS").access("hasRole('ADMIN')")
                .antMatchers("/addItem").access("hasRole('ADMIN')")
                .antMatchers("/addCategory").access("hasRole('ADMIN')")
                .antMatchers("/delCategory").access("hasRole('ADMIN')")
                .antMatchers("/adminLogin").access("hasRole('ADMIN')")
